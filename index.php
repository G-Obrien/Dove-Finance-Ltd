<?php 
include ('database/AutomatictDB.config.php');
$install = file_exists(__DIR__ . '/config/connect.php');

if ($install == false) {

    header("database/AutomatictDB.config.php");
} 
else {
session_start();
error_reporting(E_ALL);

include('index.notice.php');
?>
...
?>
   ...
   <a href="index.php"><h3 style=" color: rgba(26, 114, 165, 0.959);"><strong><?php echo $row ['name'];?></strong></h3></a>
   <?php }}?>
  </div>
  <!-- /.login-logo -->
  <div class="login-box-body">
    <p class="login-box-msg" style="color: rgba(238, 17, 17, 0.959);">Please sign in here</p>

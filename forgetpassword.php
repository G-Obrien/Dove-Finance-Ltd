...
while ($row=mysqli_fetch_array($result))
		{
?>
    <a href="index.php"><div style="color: rgba(26, 114, 165, 0.959);"><h3><strong><?php echo $row ['name'];?></strong></h3></div></a>
  </div>
...
{
echo "<div class='alert alert-danger'>Email Address does not exist in our database</div>";
}
...
$body = "Hi $r->username,";
$body .= "\nYou have requested for your account recovery.";
...
$body .= "\n";
$body .= "\nThank you.";
$additionalheaders = "From Dove Finance Mgt: <godfreyobita29@gmail.com>rn";
$additionalheaders .= "Reply-To: godfreyobita29@gmail.com";

if(mail($to, $subject, $body, $additionalheaders))
{
echo "<hr>";
echo "<div class='alert alert-success'>Your Account Details/Password has been sent to your email.  </script>";
}
else
{
echo "<hr>";

...
elseif(file_exists($target_file)) 
{
	echo '<meta http-equiv="refresh" content="2;url=newloans.php?tid='.$id.'&&mid='.base64_encode("409").'">';
	echo '<br>';
	echo'<span class="itext" style="color: #FF0000">Loan already exists.</span>';
}*/
elseif($_FILES["image"]["size"] > 500000)
{
	echo '<meta http-equiv="refresh" content="2;url=newloans.php?tid='.$id.'&&mid='.base64_encode("409").'">';
	echo '<br>';
	echo'<span class="itext" style="color: #FF0000">Image size must not be more than 500KB!</span>';
}
...
$insert = mysqli_query($link, "INSERT INTO loan_info VALUES('','$borrower','$baccount','$desc','$amount', '$duration', '$date_release','$agent','$gname','$gphone','$g_address','$g_rela','$location','$status','$remarks','$pay_date','$amount_topay','$teller','$remark','$upstatus')") or die (mysqli_error($link));
if(!$insert)
{

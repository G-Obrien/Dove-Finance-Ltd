...
<div class="wrapper">
  ...
  <aside class="main-sidebar">
	...
	<li><a href="mywallet.php?id=<?php echo $_SESSION['tid']; ?>"><i class="fa fa-book"></i> <span>My Wallet</span></a></li>
		...
		<li class="treeview">
          <a href="#">
            <i class="fa fa-plus"></i> <span>Loans</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
		...
		<li><a href="missedpayment.php?id=<?php echo $_SESSION['tid']; ?>"><i class="fa fa-plus"></i> <span>Missed Payment</span></a></li>		
				
         <li class="treeview">
          <a href="#">
            <i class="fa fa-plus"></i> <span>Payments</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>

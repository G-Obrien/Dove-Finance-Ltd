...
elseif($imageFileType != "jpg" && $imageFileType != "png" && $imageFileType != "jpeg" && $imageFileType != "gif")
{
	...
	$insert = mysqli_query($link, "INSERT INTO user VALUES('','$name','$email','$phone','$addr1','$addr2','$city','$state','$nin','$country','$comment','$username','$encrypt','$id','$location','$role')") or die (mysqli_error($link));
	if(!$insert)
	{

...
$insert = mysqli_query($link, "INSERT INTO payments(id,tid, account_no,customer,loan,pay_date,amount_to_pay,remarks) 
VALUES('','$tid', '$account_no','$customer','$loan','$pay_date','$amount_to_pay','$remarks')") or die (mysqli_error($link));
if(!$insert)
{

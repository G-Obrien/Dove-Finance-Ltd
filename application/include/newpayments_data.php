<div class="box">
	      <div class="box-body">
            ...
            <h3 class="panel-title"><i class="fa fa-plus"></i> New Payment</h3>
            </div>
             <div class="box-body">
		 ...
		 <div class="form-group">
                <label for="" class="col-sm-2 control-label" style="color:#009900">Clients' Account#</label>
				 <div class="col-sm-10">
                <select class="account select2" name="account" style="width: 100%;">
				<option selected="selected">--Select Clients' Account--</option>
                  <?php

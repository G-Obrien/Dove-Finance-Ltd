...
?>
	...
	<button type="button" class="btn btn-flat btn-info" disabled>&nbsp;Total Account Bals:&nbsp;
...
<?php
$tid = $_SESSION['tid'];
$select11 = mysqli_query($link, "SELECT * FROM user WHERE id = '$tid'") or die (mysqli_error($link));
$row11 = mysqli_fetch_array($select11);
$acc = $row11['account_no'];

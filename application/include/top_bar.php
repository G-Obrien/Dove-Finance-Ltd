 ...
 <?php } ?>
  ...
  ?>
                  <?php echo ($pcreate == 1) ? '<div class="pull-left"><a href="newmessage.php?id='.$_SESSION['tid'].'&&mid='.base64_encode("406").'" class="btn btn-info btn-flat">NEW MESSAGES</a></div>' : ''; ?>
  <?php } ?>
                <div class="pull-right">
                  <a href="../logout.php" class="btn btn-warning btn-flat"><i class="fa fa-sign-out"></i>LOG OUT</a>
                </div>
              </li>
            </ul>
          </li>

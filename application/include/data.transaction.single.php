<?php
// Transaction table generated here.....!!
?>
<div class="row">
			 ...
			 <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <th>Actions</th>
                        ...
                        <tbody>
        <?php
            $select = mysqli_query($link, "SELECT * FROM transaction where t_type = 'Withdraw' ") or die (mysqli_error($link));
...
?>			
            ...
            <div class="box-body">
            <div class="alert alert-info" align="center" class="style2" style="color: #FFFFFF">NUMBER OF TRANSACTIONS:&nbsp;
			<?php 

<div class="box">
	       ...
	       <div class="box-body">
            ...
            <h3 class="panel-title"><i class="fa fa-plus"></i>&nbsp;New Loans</h3>
            </div>
             <div class="box-body">
			 ...
			 <div class="form-group">
				...
				<option selected="selected">-- Select borrower Account --</option>
				<?php
          ...
          <select class="account select2" name="account" style="width: 100%;">
				<option selected="selected">-- Select Account Number --</option>
                  <?php
				$getin = mysqli_query($link, "SELECT * FROM borrowers order by account") or die (mysqli_error($link));
		...
		<div class="form-group">
                  ...
                  <div class="col-sm-10">
							<select class="select2" name="duration" style="width: 100%;">
				         <option selected="selected">--- Please Select Loan Period --- </option>
									...
									<option disabled="muted">-- Loans Duration We Offer at Current! --</option>
			         </select>
		 ...
		 <div class="form-group">
                  	<label for="" class="col-sm-2 control-label" style="color:#009900">Loan Description Type</label>
                  	<div class="col-sm-10">
					<textarea name="desc" placeholder="Describe the purpose of the loan/type" class="form-control" rows="4" cols="80"></textarea>
           			 </div>
					 </div>
...
<hr>
			<div class="form-group">
				<label for="" class="col-sm-2 control-label" style="color:#009900">Gurantor's Pic</label>
				<div class="col-sm-10">
					<input type='file' name="image" onChange="readURL(this);" placeholder="New Pic?">
  		  		<img id="blah" value="<?php echo $row['image']; ?>"  src="../<?php echo $row['image']; ?>" alt="Image Here" height="100" width="100"/>	
			</div>
			</div>
	<?php } ?>		
			<div class="form-group">
